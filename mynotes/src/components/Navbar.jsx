...
const Navbar = ({userInfo, onSearchNote, handleClearSearch,isDark,setIsDark}) => {
...
return (
  <motion.div 
    ...
    className="bg-white dark:bg-gray-800 flex items-center justify-between px-2 py-2 drop-shadow transition-colors duration-300"
  >

  

    <Link to={"/"}>      
      <h2 className="text-xl font-medium text-black dark:text-white py-2 flex items-center gap-2">
